...
vec3 ka = vec3(1, 1, 0);   // ambient reflectance coefficient
vec3 ks = vec3(0.2, 0.2, 0.2);   // specular reflectance coefficient
vec3 lightPos = vec3(0, 0, 0);   // light position in world coordinates
//kd and ks changable
